...
class Parser(argparse.ArgumentParser):
    def __init__(self):
        super(Parser, self).__init__(description='2D Coupled Burgers Equation')
        self.add_argument('--exp-name', type=str, default='burgers2dswag', help='experiment name')
        ...
        self.add_argument('--init-features', type=int, default=96, help='number of initial features after the first conv layer')        
        ...
        self.add_argument('--ntrain', type=int, default=5120, help="number of training data")
        ...
        self.add_argument('--nu', type=float, default=0.005, help="viscosity")
        ...
        self.add_argument('--batch-size', type=int, default=128, help='batch size for training')
        ...
        self.add_argument('--swag-lr', type=float, default=1e-7, help='ADAM learning rate during swag sampling')
        self.add_argument('--swag-lr-beta', type=float, default=0.0001, help='ADAM learning rate of output noise during swag sampling')
